...
function the_returned_search_query() {
	...
	#popup_div_'.$pop_id_num.'{display: block; color: '.$pop_text_color.'; font-style: italic;font-weight: bold; display: none; background-color: '.$pop_bg_color.'; border: '.$pop_border_width.'px '.$pop_border_color.' solid;position:absolute;left:-2500px; padding: 20px; z-index: 100000;}
...
function my_scripts_method() {
    ...
    wp_register_script( 'jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.j');
...
function my_admin_scripts() {
    ...
    wp_enqueue_script( 'info_popup', "informational-popup.js" );
}
