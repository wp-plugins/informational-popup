...
function my_theme_options() {
        ...
        //if no options are set in the data base, this will make the preview box visible
...
//]]></script>
	...
	<form id="pop_style_form" method="POST" action="../wp-content/plugins/informational-popup/info_popup_set_options.php">
	<table>
	<tr>
	<td>
	...
	<br />
	<input type="submit" id="submit_popup_options" value="save changes" class="custom_button" />
	</div>
