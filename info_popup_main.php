...
function the_returned_search_query() {
	return get_search_query();//esc_attr( apply_filters( 'the_search_query', get_search_query( false ) ) );
}
	...
	//get the size of the message to help size the box
		...
		$display_class = 'no_display';
        
         
}	else{
            $display_class ='yes_display';
       
        
}
       //return the script, css and html that creates the poup box
       return '<script type="text/javascript" id="info_popup_script_tag_'.$pop_id_num.'">
	...
	<br />
	<img src="'.$pop_image.'" alt=" " class="'.$display.'" id="img_tag_'.$pop_id_num.'" />
	<br />
	...
	#h4_'.$pop_id_num.'{opacity:0%;color: '.$pop_text_color.';}
        ...
        #video_div_'.$pop_id_num.'{position: relative; top:-25px; z-index:9999;}
	</style>';
}
...
?>
	<a href="<?php echo bloginfo('wpurl'); echo '/wp-content/plugins/info_pop_plugin/tester.php'; ?>">info popup manager</a><br /><p>Choose styles for your shortcode popups.</p>
<?php } 
...
$blog_url = get_bloginfo('wpurl');
 wp_deregister_script( 'jquery_ui' );
  ...
  wp_deregister_script( 'farbtastic' );
    wp_register_script( 'farbtastic', "$blog_url /wp-content/plugins/info_pop_plugin/farbtastic.js");
    wp_enqueue_script( 'farbtastic' );


    //wp_deregister_script( 'info_popup_js' );
    wp_register_script( 'info_popup_js', "$blog_url/wp-content/plugins/info_pop_plugin/info_popup.js");
...
<script type="text/javascript" src="<?php echo bloginfo('wpurl');?>/wp-content/plugins/info_pop_plugin/info_popup.js"></script>
<script type="text/javascript" src="<?php echo bloginfo('wpurl');?>/wp-content/plugins/info_pop_plugin/farbtastic.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo bloginfo('wpurl');?>/wp-admin/css/farbtastic.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo bloginfo('wpurl');?>/wp-content/plugins/info_pop_plugin/info_popup.css" />
...
//]]></script>
	...
	<form id="pop_style_form" method="POST" action="<?php echo bloginfo('wpurl');?>/wp-content/plugins/info_pop_plugin/info_popup_set_options.php">
	<table>
	<tr>
	<td>
	...
	<br />
	<input type="submit" id="submit_popup_options" class="custom_button" />
	</div>
...
function my_admin_scripts() {
    ...
    wp_enqueue_script( 'info_popup', "info_pop_plugin.js" );
}
