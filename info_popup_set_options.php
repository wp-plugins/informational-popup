...
?>       
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo site_url('/');?>wp-content/plugins/info_pop_plugin/info_popup.css" /> 
	</head>
	<body>
	...
	<h3 class="set_options_header"><a href="<?php echo site_url('/');?>"><span id="home_from_info_update">Return to homepage.</span></a></h3>
        <br />
         <h3 class="set_options_header"><a href="<?php echo site_url('/');?>wp-content/plugins/info_pop_plugin/info_popup_view.php">Go back to infomational popup styles</a></h3>
</div>
</body>
</html>
<?php 
